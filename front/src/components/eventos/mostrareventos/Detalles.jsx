import "../../../App.css";
import { Button, Toast, Modal } from "react-bootstrap";  // agregamos Modal aquí
...
import { getEventoPorId, modificarEvento } from "../../../services/api"; // agregué modificarEvento
import FormularioEditarEvento from "../mostrareventos/FormularioEditarEvento"; // importá el formulario correctamente
  ...
  return (
    ...
    <div className="evento-detalle text-white" style={{ maxWidth: "900px", margin: "2rem auto", padding: "1.5rem" }}>
      ...
      <div className="mb-3">
        ...
        <p><strong>Horario:</strong> {horarioEvento}</p>
